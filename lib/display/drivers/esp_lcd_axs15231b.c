...
/**
 * AXS15231B QSPI LCD panel driver with integrated touch support.
 *
 * Copied from Waveshare ESP32-S3-Touch-LCD-3.49 reference code
 * (references/ESP32-S3-Touch-LCD-3.49/Examples/Arduino/09_LVGL_V8_Test/src/axs15231b/esp_lcd_axs15231b.c)
 * with minimal modifications:
 *   - Changed touch header include path
 *   - Updated color_space -> rgb_ele_order for ESP-IDF 5.x compatibility
 *
 * The default init sequence (vendor_specific_init_default) is for the 172x640 panel.
 * For 320x480 (3.5B-C), pass a different init_cmds array via vendor_config.
 */
...
/* Default init sequence for 172x640 panel (3.49 board) */
...
/* ========================================================================== */
/* Touch driver (AXS15231B integrated touch)                                  */
/* ========================================================================== */
