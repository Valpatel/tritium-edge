...
/**
 * Generic QSPI AMOLED panel driver for SH8601Z, RM690B0, and RM67162.
 *
 * Copied from Waveshare ESP32 components (references/Waveshare-ESP32-components/
 * display/lcd/esp_lcd_sh8601/esp_lcd_sh8601.c) with minimal modifications.
 *
 * Each panel IC is differentiated solely through the init_cmds array
 * passed via vendor_config at panel creation time.
 */
