...
echo ""
echo "Quick start:"
echo "  List connected boards:   pio device list"
echo "  Build for 2.41-B board:  pio run -e touch-amoled-241b"
echo "  Upload to 2.41-B board:  pio run -e touch-amoled-241b -t upload"
echo "  Monitor serial output:   pio device monitor -b 115200"
echo ""
